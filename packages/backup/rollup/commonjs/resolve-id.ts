...
import { statSync } from "@zenfs/core";
import { dirname, resolve, sep } from "@zenfs/core/emulation/path.js";
...
export default function getResolveId(
  extensions: string[],
  isPossibleCjsId: (id: string) => boolean,
): {

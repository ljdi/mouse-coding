import { existsSync, readFileSync, statSync } from '@zenfs/core';
import { join, resolve, dirname } from '@zenfs/core/emulation/path.js';
...
function getPackageEntryPoint(dirPath: string) {

export const isWrappedId = (id: string, suffix: string) => id.endsWith(suffix);
export const wrapId = (id: string, suffix: string) => `\0${id}${suffix}`;
export const unwrapId = (wrappedId: string, suffix: string) =>
